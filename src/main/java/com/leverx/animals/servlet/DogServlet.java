...
public class DogServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        Dog dog = gson.fromJson(CharStreams.toString(req.getReader()), Dog.class);
        responseSender.sendResponse(resp, SC_OK, JSON_CONTENT_TYPE, gson.toJson(animalService.create(dog)));
    }
